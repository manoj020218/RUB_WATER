...
static const char DEFAULT_MQTT_HOST[] = "FGServer.jenix.in";
static const uint16_t DEFAULT_MQTT_PORT = 1883;
static const char DEFAULT_MQTT_USER[] = "floodguard_device";
static const char DEFAULT_MQTT_PASS[] = "change_me";
static const char DEFAULT_HTTP_BASE_URL[] = "http://FGServer.jenix.in";
...
static const int RS485_DERE_PIN = 18;
