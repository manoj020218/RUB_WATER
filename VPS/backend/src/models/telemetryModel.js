...
function createTelemetryRecord(payload) {
  ...
  return {
    ...
    current_action_sheet_version: num(payload.current_action_sheet_version ?? payload.action_sheet_version, 0),
    action_sheet_sync_source: text(payload.action_sheet_sync_source, ''),
    action_sheet_last_sync_at: text(payload.action_sheet_last_sync_at, ''),
