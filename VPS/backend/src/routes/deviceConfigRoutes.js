...
const deviceActionSheetController = require('../controllers/deviceActionSheetController');
...
router.get('/:deviceId/action-sheet', deviceActionSheetController.getDeviceActionSheet);
router.put('/:deviceId/action-sheet', deviceActionSheetController.putDeviceActionSheet);
router.post('/:deviceId/action-sheet/push', deviceActionSheetController.pushDeviceActionSheet);
router.get('/:deviceId/action-sheet/history', deviceActionSheetController.getDeviceActionSheetHistory);
